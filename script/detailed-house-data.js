...
import { initializeImageSlider } from "../detailed-listing-page/Detailed Listing image slider.js";
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (selectedHouse) {
        ...
        document.querySelector('.Booking-Fee').innerHTML =  
            `<p>Booking-Fee (0ptional & Non-Refundable):</p>
        ...
        document.querySelector('.roommate-message textarea').innerText = `Hello, I am interested in booking a room in this ${selectedHouse.house_overview.house_name} and I am currently looking for a Roomate. Use this link to see the house's details`;
